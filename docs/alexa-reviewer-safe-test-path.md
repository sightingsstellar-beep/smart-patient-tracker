...
Purpose: prepare Amazon certification access for Glide Patient Tracker without storing reviewer passwords, tokens, or secret values in the repo, Mission Control, docs, or chat.
