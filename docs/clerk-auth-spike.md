...
This spike validates Clerk as the candidate identity provider for Smart Patient Tracker before replacing the existing shared-password dashboard login.
...
- Vault: `Mr. Stellar`
- Item: `Clerk Credentials for Smart Patient Tracker Spike`
- Fields:
...
CLERK_PUBLISHABLE_KEY=op://Mr. Stellar/Clerk Credentials for Smart Patient Tracker Spike/CLERK_PUBLISHABLE_KEY
CLERK_SECRET_KEY=op://Mr. Stellar/Clerk Credentials for Smart Patient Tracker Spike/CLERK_SECRET_KEY
EOF
```
