...
This spike validates Clerk as the candidate identity provider for Glide Bedside before replacing the existing shared-password dashboard login.
...
- Vault: `Mr. Stellar`
- Item: `Clerk Credentials for Glide Bedside Spike`
- Fields:
...
CLERK_PUBLISHABLE_KEY=op://Mr. Stellar/Clerk Credentials for Glide Bedside Spike/CLERK_PUBLISHABLE_KEY
CLERK_SECRET_KEY=op://Mr. Stellar/Clerk Credentials for Glide Bedside Spike/CLERK_SECRET_KEY
EOF
```
